...
module RailsApiBoilerplate
  class Application < Rails::Application
    ...
    config.action_mailer.default_url_options = { host: Figaro.env.SERVER_URL }
    config.action_mailer.default_options = {
      from: Figaro.env.DEFAULT_FROM_EMAIL_ADDRESS,
      reply_to: Figaro.env.DEFAULT_FROM_EMAIL_ADDRESS
    }
